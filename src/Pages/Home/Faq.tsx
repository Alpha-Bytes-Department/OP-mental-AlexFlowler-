  ...
  return <div className=" sm:py-48 py-20 bg-[url('/background.png')] bg-cover">
    ...
    <div className="max-w-4xl px-5 mx-auto mt-10 flex flex-col gap-5 py-10">
        <div className="collapse text-white collapse-plus bg-white/10 backdrop-blur-sm border border-hCard rounded-xl shadow-lg">
            ...
            <div className="collapse-title text-2xl font-montserrat font-semibold text-yellow-500">1. How is my data protected?</div>
        ...
        <div className="collapse text-white collapse-plus bg-white/10 backdrop-blur-sm border border-hCard rounded-xl shadow-lg">
            <input type="radio" name="my-accordion-3" />
            <div className="collapse-title text-2xl font-montserrat font-semibold text-yellow-500">2. Can I cancel anytime?</div>
            <div className="collapse-content font-montserrat text-sm font-semibold text-hCard">
        ...
        <div className="collapse text-white collapse-plus bg-white/10 backdrop-blur-sm border border-hCard rounded-xl shadow-lg">
            <input type="radio" name="my-accordion-3" />
            <div className="collapse-title text-2xl font-montserrat font-semibold text-yellow-500">3. Does the AI Coach Replace human coaching?</div>
            <div className="collapse-content font-montserrat text-sm font-semibold text-hCard">
        ...
        <div className="collapse text-white collapse-plus bg-white/10 backdrop-blur-sm border border-hCard rounded-xl shadow-lg">
            <input type="radio" name="my-accordion-3" />
            <div className="collapse-title text-2xl font-montserrat font-semibold text-yellow-500">4. What genres or styles does it support?</div>
            <div className="collapse-content font-montserrat text-sm font-semibold text-hCard">
